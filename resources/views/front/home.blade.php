                                ...
                                @if ($key < 5)
                                    <div class="single-slider"
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="button">
                                                {{-- <a href="{{ route() }}" class="btn">Shop Now</a> --}}
                                            </div>
                                        </div>
                                    </div>
                                @else
                    ...
                    <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                        ...
                        @if ($products->first())
                            <div class="hero-small-banner"
                                style="background-image: url({{ $products->first()->image_url }});">
                                <div class="content">
                                    <h2>{{ $products->first()->name_translate }}</h2>
                                    <h3>{{ Currency::format($products->first()->price) }}</h3>
                                </div>
                            </div>
                        @endif
                        <!-- End Small Banner -->
                    ...
                    <div class="col-lg-12 col-md-6 col-12">
                        ...
                        <div class="hero-small-banner style2">
                            <div class="content">
                                ...
                                <div class="button">
                                    <a class="btn" href="{{route('products.index')}}">{{ __('Shop Now') }}</a>
                                </div>
                            </div>
                        </div>
                        <!-- Start Small Banner -->
